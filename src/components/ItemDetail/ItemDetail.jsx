        ...
        <div key={product.id} className="container mt-5">
            <div className="row justify-content-center text-center align-items-center">
                <div className="col-lg-6 col-md-12 col-sm-12 pb-5">  
                    <img src={product.image} className="itemDetail-img"></img>
                </div>
                <div className="col-lg-6 col-md-12 col-sm-12">
                    <h3 className="fw-bold">{product.name}</h3>
                    <h4>{formatearDinero(product.price)}</h4>
                    ...
                    : 
                        <div className="d-flex justify-content-center">
                            ...
                            <Link to={`/`}> 
                                <button className="btn btn-success bg-gradient ms-3 mt-3">Seguir comprando</button>
                            </Link>
                        </div>
                    }
                </div>
